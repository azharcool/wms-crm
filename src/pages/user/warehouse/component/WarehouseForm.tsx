      ...
      <PerfectScrollbar>
        ...
        <Divider sx={{my:1}}/>
          ...
          >
            <TextField
            isSelect
              error={!!touched.pickingStrategy && !!errors.pickingStrategy}
              helperText={
                (touched.pickingStrategy && errors && errors.pickingStrategy) ||
                ""
              }
          ...
          >
            <TextField
            isSelect
              error={!!touched.receivingStrategy && !!errors.receivingStrategy}
              helperText={
                (touched.receivingStrategy && errors && errors.receivingStrategy) ||
                ""
              }
          ...
          >
            ...
            isSelect
              ...
              helperText={
                (touched.receivingType && errors && errors.receivingType) ||
                ""
              }

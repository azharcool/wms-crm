...
import useNotesForm from "pages/user/contacts/details/component/notes/useNotesForm";
// import useNotesForm, {
//   INotesForm,
// } from "pages/user/contacts/hooks/useNotesForm";
...
function QuickReplyPopup(props: Props) {
  ...
  const onSubmit = async (values: any) => {
    tempArr.push({ id: Math.random(), note: values.addNotes });
